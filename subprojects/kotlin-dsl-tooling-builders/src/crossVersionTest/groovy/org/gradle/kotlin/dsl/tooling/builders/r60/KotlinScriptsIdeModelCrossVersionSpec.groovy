...
import org.gradle.kotlin.dsl.resolver.KotlinDslScriptsIdeModelClient
import org.gradle.kotlin.dsl.resolver.KotlinDslScriptsIdeModelRequest
import org.gradle.kotlin.dsl.tooling.builders.AbstractKotlinScriptModelCrossVersionTest


@TargetGradleVersion(">=6.0")
class KotlinScriptsIdeModelCrossVersionSpec extends AbstractKotlinScriptModelCrossVersionTest {

    def "can fetch IDE model for a set of scripts"() {
        ...
        def model = withConnection { connection ->
            KotlinDslScriptsIdeModelClient.fetchKotlinDslScriptsIdeModel(
                connection,
                new KotlinDslScriptsIdeModelRequest([settings, root, a, b])
            )
        }
